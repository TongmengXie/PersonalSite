...
```{mermaid}
%%{init: {'theme':'base', 'themeVariables': {'edge': 'green'}}}%%
flowchart LR;
  A[Comprehensive Plan for New York City]
  B[Expanding Voting Rights]
  C[Increasing Digital Literacy]
  D[Providing Economic Security]
  E[Good-Paying Jobs]
  F[Support for Students in Temporary Housing]
  G[Access to Open Spaces & Cultural Resources]
  H[Neighborhood Open Spaces]
  I[Cultural Resources]
  J[Promoting Healthy Lifestyles]
  K[Achieving Carbon Neutrality]
  L[Climate Accountability]
  M[Climate Justice]
  N[Enhancing Walkability & Accessibility]
  O[Improving Infrastructure]
  P[Reducing Congestion & Emissions]
  Q[Strengthening Regional & Global Connections]
  R[Core Physical Infrastructure & Hazard Mitigation]
  S[Digital Infrastructure]
  T[Asset Maintenance & Capital Project Delivery]
  U[Milestones]
  V[December 31, 2020]
  W[December 31, 2021]
  X[Goals]
  Y[Empower New Yorkers in Democracy]
  Z[Grow the Economy]
  AA[Access to Open Spaces & Cultural Resources]
  AB[Improve Education]
  AC[Achieve Carbon Neutrality]
  AD[Strengthen Communities]
  AE[Improve Mobility]
  AF[Diversity & Inclusion]
