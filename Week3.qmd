...
From literature we delve in the nuances of levels on which we perform image fusion to acquire better results. The integration methods vary as the levels vary. \@Better together: Integrating and fusing multispectral and radar satellite imagery to inform biodiversity monitoring, ecological research and conservation science.
...
![](images/fusion%20techniques.png){#fig-fusiontech}
...
### Implementation approach ![](images/Implementation%20approach.png){#fig-impleApproach}
